...
/**
 * Un ParedIndestructible es un obstáculo que puede ser destruido por una
 * {@link NaveDeAtaque}. Esto llevará una cierta cantidad de ataques
 */
public class ParedIndestructible extends ActorBase implements Dañable {
	/**
	...
	/**
	 * Es el tamaño actual del ParedIndestructible, que tiene relación directa con la cantidad
	 * de ataques necesarios para eliminarlo
	 */
	protected int tamaño;

	/**
	 * Inicializa un ParedIndestructible con tamaño aleatorio entre 51 y 100 puntos
	 */
	 ...
	 * @param tamañoInicial
	 */
	public ParedIndestructible(int tamañoInicial) {
		this.tamaño = Math.max(TAMAÑO_MINIMO_DE_ASTEROIDE, Math.min(TAMAÑO_MAXIMO_DE_ASTEROIDE, tamañoInicial));
	}

	/**
	 * post: el ParedIndestructible reducirá su tamaño conforme la potencia del ataque. <br>
	 * post: el ParedIndestructible será eliminado del tablero si su tamaño llega a 0. <br>
	 * 
	 ...
	 * {@value #TAMAÑO_MAXIMO_DE_ASTEROIDE}
	 * 
	 * @return el tamaño máximo que puede tener un ParedIndestructible
	 */
	 ...
	 * {@link #tamaño}
	 * 
	 * @return el tamaño del ParedIndestructible
	 */
